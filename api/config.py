...
def load_generator_config():
    ...
    if "providers" in generator_config:
        for provider_id, provider_config in generator_config["providers"].items():
            ...
            elif provider_id in ["google", "openai", "openrouter", "opencode", "ollama", "bedrock", "azure", "dashscope"]:
                default_map = {
...
def get_model_config(provider="google", model=None):
    ...
    Parameters:
        provider (str): Model provider ('google', 'openai', 'openrouter', 'opencode', 'ollama', 'bedrock')
